...
dotnet ef dbcontext scaffold "Server=.;Database=SmartGarden;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer --schema Data --schema Catalogs  --project "..\Core.DataObjects" --output-dir ".\EFObjects" --context-dir "..\DataAccess\DbContexts" --context SGContext --force --no-build
